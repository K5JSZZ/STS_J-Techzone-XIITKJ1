...
<div class="w-full max-w-6xl mx-auto flex flex-col md:flex-row gap-4 p-4">
    ...
    <div class="flex-1 bg-[#0f0f1a] p-10 rounded-l-2xl overflow-y-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-4xl font-semibold">Payment Methods</h1>
            <button class="bg-indigo-600 hover:bg-indigo-700 transition text-white px-4 py-2 rounded-lg text-sm font-medium">
                + Add Payment Method
            </button>
        </div>


        <div class="bg-[#1b1b2b] rounded-lg shadow-lg divide-y divide-gray-700 overflow-hidden">


            <div class="flex justify-between items-center py-4 px-6 hover:bg-[#25253a] transition cursor-pointer">
                <span class="text-lg font-medium">GoPay</span>
                <span class="text-gray-400 text-xl">›</span>
            </div>


            <div class="flex justify-between items-center py-4 px-6 hover:bg-[#25253a] transition cursor-pointer">
                <span class="text-lg font-medium">DANA</span>
                <span class="text-gray-400 text-xl">›</span>
            </div>


            <div class="flex justify-between items-center py-4 px-6 hover:bg-[#25253a] transition cursor-pointer">
                <span class="text-lg font-medium">Debit Card</span>
                <span class="text-gray-400 text-xl">›</span>
            </div>
