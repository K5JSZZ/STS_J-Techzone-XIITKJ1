            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <nav class="flex items-center space-x-6 text-white font-medium">
                    <div class="relative">
                        ...
                        <ul id="produkMenu" class="absolute cursor-pointer mt-2 hidden flex-col text-sm bg-white text-black shadow-lg min-w-[200px]">
                            <li class="group relative">
                                <button class="flex items-center justify-between w-full px-4 py-2 hover:bg-gray-100 hover:text-blue-600">
                                    <span>Laptop</span>
                                ...
                                <ul class="absolute cursor-pointer left-full top-0 hidden group-hover:flex flex-col bg-white text-black shadow-lg min-w-[180px]">
                                    <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">Gaming Laptop</li>
                                    <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">Ultrabook</li>
                                    <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">Laptop Harian</li>
                                </ul>
                            </li>
                            <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">Handphone & Tablet</li>
                            <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">AIO & Desktop PC</li>
                            <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">Mini PC</li>
                            <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">PC Monitor</li>
                            <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">Networking</li>
                            <li class="px-4 py-2 hover:bg-gray-100 hover:text-blue-600">Smartwatch</li>
                        </ul>
                    </div>
                ...
                <a href="#" class="text-sm/6 font-semibold text-white">Merchant</a>
            </div>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end gap-5">
                <a href="{{url('login')}}" class="rounded-md bg-purple-500 px-3.5 py-2.5 text-sm font-semibold text-white inset-ring inset-ring-white/5 hover:bg-white hover:text-black  focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"> Log in </a>
                <a href="{{url('SignUp')}}" class="rounded-md bg-purple-500 px-3.5 py-2.5 text-sm font-semibold text-white inset-ring inset-ring-white/5 hover:bg-white hover:text-black focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"> Sign Up </a>
            </div>
        </nav>
        <el-dialog>
                        ...
                        <div class="mt-6 flow-root">
                            <div class="-my-6 divide-y divide-white/10">
                                <div class="space-y-2 py-6">
                                    ...
                                    <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">About Me</a>
                                    <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Contact Me</a>
                                    <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Shop</a>
                                    <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Merchant</a>
                                </div>
                                <div class="py-6">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="flex flex-col justify-center gap-0 text-center">
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="#" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Start Shopping</a>
...
<div class="bg-gray-900 py-24 sm:py-32">
    ...
    document.addEventListener('click', (e) => {
        if (!produkBtn.contains(e.target) && !produkMenu.contains(e.target)) {
